...
@interface YlinkVGPathElement()
@property (nonatomic) CGPoint lastPoint;
@end

@implementation YlinkVGPathElement
...
- (instancetype)initWithAttributes:(NSDictionary *)attributes
{
    ...
    [YinkSVGUtils parseTransform:self.tranform];
...
{
    NSArray* coordinates = [YinkSVGUtils parsePoints:value];
